...
public enum ConflictErrorResult {
    ...
    REQUEST_PAYMENT_EVENT_STATUS_CONFLICT_EXCEPTION(HttpStatus.CONFLICT.value(), "REQUESTED PAYMENT EVENT STATUS CONFLICT EXCEPTION", "RPESCE007"),
    INVALID_PAYMENT_EVENT_STATUS_CONFLICT_EXCEPTION(HttpStatus.CONFLICT.value(), "INVALID PAYMENT EVENT STATUS CONFLICT EXCEPTION", "IPESCE008"),
    ;
