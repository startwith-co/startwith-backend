...
public enum NotFoundErrorResult {
    ...
    PAYMENT_EVENT_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND.value(), "PAYMENT EVENT NOT FOUND EXCEPTION", "PENFE005"),
    PAYMENT_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND.value(), "PAYMENT NOT FOUND EXCEPTION", "PNFE006"),
    ;
