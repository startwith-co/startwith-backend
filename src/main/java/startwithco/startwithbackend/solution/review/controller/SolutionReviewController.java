...
public class SolutionReviewController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "CONFLICT_EXCEPTION_005", description = "같은 솔루션에 리뷰는 한 번만 작성할 수 있습니다.", content = @Content(schema = @Schema(implementation = GlobalExceptionHandler.ErrorResponse.class))),
